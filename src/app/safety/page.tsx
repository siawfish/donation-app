...
const guidance: {
...
}[] = [
  {
    ...
    title: "Meeting up",
    tips: [
      "Choose a public place — a shop doorway, a community centre, somewhere with people around.",
  ...
  },
  {
    ...
    tips: [
      ...
      "Ask the lister a question first if anything is unclear — that's what \"Ask for it\" starts.",
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Givny puts neighbours directly in touch with each other — no fees, no middleman.
            That&apos;s what makes it work, and it&apos;s also why a little care goes a long way.
          </p>
        </div>
