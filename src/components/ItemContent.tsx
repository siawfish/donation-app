...
import { CalendarIcon, EyeIcon, HandIcon, MessageCircleIcon, PencilIcon } from "lucide-react"
...
export default function ItemContent() {
    ...
    useEffect(() => {
        ...
        void (async () => {
            setLoading(true)
            if (!user) throw new Error('Unauthorized. If problem persists, please sign in again.')
            try {
                ...
                toast.error('Error fetching item', { description: message })
            } finally {
                setLoading(false)
            }
        })()
